...
data_path = 'C:\\Visual_studio\\intern\\tsv-data\\merge_lt_dict_v3.tsv'
...
for i in range(1, 845):
    ...
    f_path = 'C:\\Visual_studio\\intern\\law_txt_files\\' + f_name + '.txt'
...
if len(ccur_list) > 0:
    functions.create_df(ccur_list, 'C:\\Visual_studio\\intern\\tsv-data\\coocur_v2.tsv', [
